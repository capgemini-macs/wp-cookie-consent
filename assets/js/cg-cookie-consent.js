...
function setCookie(e, o, r) {
  ...
  var i = null;
  r !== "session" && (i = "expires=" + t.toUTCString()),
...
function runScripts() {
  ...
  try {
    for (
      var _iterator = scripts[Symbol.iterator](), _step;
      ...
      if (script.getAttribute("data-cookies") === "accepted") {
        ...
        var oScriptText = document.createTextNode(script.text);
        oScript.appendChild(oScriptText);
        document.body.appendChild(oScript);
        customDataLayer = _.merge(
          customDataLayer,
          window.dataLayerItems[script.getAttribute("data-name")]
        );
      }
